      ...
      <Paper className={classes.root} elevation={1}>
        ...
        <Paper className={classes.root} elevation={1}>
          ...
          <Typography component="p" className={classes.paragraph}>
            ...
            下準備としてブラウザ拡張機能の「<a rel="noopener noreferrer" href="https://chrome.google.com/webstore/detail/waves-keeper/lpilbniiabackdjcionkobglmddfbcjo" target="_blank">WavesKeeper</a>」を入手してください。
          </Typography>
          ...
          <Grid container justify="space-around">
            ...
            <div className={classes.dirDiv}>
              <p><b>② <a rel="noopener noreferrer" href="https://wavesexplorer.com/testnet/faucet" target="_blank">Faucet</a>に入金申請</b></p>
